...
float Toltesek::getQ() {return q;}
float Toltesek::getM() {return m;}
sf::Vector2f Toltesek::getPozi() {return pozi;}
sf::Vector2f Toltesek::getSeb() {return seb;}
sf::Vector2f Toltesek::getGyors() {return gyors;}
sf::CircleShape& Toltesek::getKor() {return kor;}

void Toltesek::setPozi(sf::Vector2f kov) {pozi = kov;kor.setPosition(pozi);}
